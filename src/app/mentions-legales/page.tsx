            ...
            <main className="px-4 pt-28 pb-12 max-w-4xl mx-auto text-justify space-y-10">
                ...
                <section>
                    ...
                    <p>
                        ...
                        (LCEN), il est porté à la connaissance des utilisateurs et visiteurs du site{" "}
                ...
                <section>
                    ...
                    <p>
                        ...
                        Site web :{" "}
                        <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-[#3fa0ff] hover:underline">
                            https://vercel.com
                        </a>
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        <strong>SoloTofs Cars</strong> est un garage automobile spécialisé en :
                    </p>
                    <ul className="list-disc list-inside mt-2">
                        ...
                        <li>Contrôle, entretien et réparation de véhicules</li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        des Données (RGPD), toute personne dispose d'un droit d'accès, de rectification
                        et de suppression des données la concernant.
                        <br />
                        Vous pouvez exercer ce droit à tout moment en nous contactant à l'adresse suivante :{" "}
                    ...
                    <p className="mt-3">
                        Les données collectées via le formulaire de contact sont exclusivement utilisées
                        pour répondre à votre demande de renseignement, de rendez-vous ou de devis.
                ...
                <section>
                    ...
                    <p>
                        Le site <strong>solotofs-cars.fr</strong> n'utilise pas de cookies de suivi
                        publicitaire. Seules des mesures d'audience anonymisées peuvent être effectuées
                        à des fins statistiques via des outils tels que Google Search Console.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        L'ensemble du contenu du site (textes, images, graphismes, logo, vidéos, etc.)
                        est la propriété exclusive de <strong>SoloTofs Cars</strong> ou fait l'objet
                        d'une autorisation d'utilisation. Toute reproduction ou utilisation non autorisée
                ...
                <section>
                    ...
                    <p>
                        <strong>SoloTofs Cars</strong> s'efforce d'assurer l'exactitude et la mise à jour
                        des informations diffusées sur son site. Cependant, elle ne saurait être tenue
                        responsable de toute erreur, omission ou interruption du service.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        <strong>SoloTofs Cars</strong> se réserve le droit de modifier à tout moment
                        les présentes mentions légales. L'utilisateur est invité à les consulter régulièrement.
                    </p>
                </section>
